...
import com.pressing.pressing.api.repository.ClotureCaisseRepository;
    ...
    public String commandesCsv(LocalDate debut, LocalDate fin) {
        ...
        for (Commande c : commandes) {
            ...
            sb.append(c.getNumeroTicket()).append(";")
              ...
              .append(c.getStatut() != null ? c.getStatut().name() : "").append(";")
              .append(fmt(total)).append(";")
              .append(fmt(paye)).append(";")
              .append(fmt(remise)).append(";")
              .append(fmt(reste)).append(";")
              .append(c.getStatutLivraison() != null ? c.getStatutLivraison().name() : "").append("\n");
        }
        return sb.toString();
    }
    ...
    public String paiementsCsv(LocalDate debut, LocalDate fin) {
        ...
        for (Paiement p : paiements) {
            sb.append(p.getDatePaiement() != null ? p.getDatePaiement().format(DT) : "").append(";")
              ...
              .append(p.getMoyenPaiement() != null ? p.getMoyenPaiement().name() : "").append(";")
              .append(p.getTypePaiement() != null ? p.getTypePaiement().name() : "").append(";")
