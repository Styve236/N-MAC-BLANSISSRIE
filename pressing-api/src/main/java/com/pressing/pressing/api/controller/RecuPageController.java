...
import com.pressing.pressing.api.dto.response.LigneRecuDTO;
import com.pressing.pressing.api.dto.response.PaiementRecuDTO;
...
@io.swagger.v3.oas.annotations.tags.Tag(name = "Recus (page)", description = "Pages HTML imprimables des recus")
